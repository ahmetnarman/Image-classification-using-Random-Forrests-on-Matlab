function [ data_train, data_query,t_building_cb,t_quantisation_tr,t_quantisation_te ] = getData( numBins )
...
tic
desc_sel = single(vl_colsubset(cat(2,desc_tr{:}), 15e4)); % Randomly select 100k SIFT descriptors for clustering
